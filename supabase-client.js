(function(){
  ...
  async function signInAnonymous(){if(!client)throw new Error('Supabase no configurado');return client.auth.signInAnonymously()}
  window.ControlHorarioSupabase={configured:ready,client,auth:{getSession,signIn,signUp,signInAnonymous,signOut}};
})();
